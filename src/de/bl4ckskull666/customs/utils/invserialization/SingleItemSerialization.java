package de.bl4ckskull666.customs.utils.invserialization;
...
public static ItemStack getItem(JSONObject item, int index) {
		try {
			...
			if(!Util.isNum(id) && Material.getMaterial(id) == null)
				throw new IllegalArgumentException("Item " + index + " - No Material found with Material of " + id);
                        else if(Util.isNum(id) && Material.getMaterial(Integer.parseInt(id)) == null)
